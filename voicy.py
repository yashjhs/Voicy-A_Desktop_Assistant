...
from voicy_Ui import Ui_MainWindow
import sys
import main
...
class Gui_Start(QMainWindow):
    ...
    def startFunc(self):
        ...
        self.jarvis_ui.movies = QtGui.QMovie("./asset/main.gif")
        ...
        self.jarvis_ui.movies_2 = QtGui.QMovie("./asset/Earth.gif")
        ...
        self.jarvis_ui.movies_3 = QtGui.QMovie("./asset/initial.gif")
